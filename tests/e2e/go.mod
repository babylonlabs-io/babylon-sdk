...
require google.golang.org/genproto/googleapis/api v0.0.0-20250528174236-200df99c418a
...
replace github.com/CosmWasm/wasmd => github.com/CosmWasm/wasmd v0.55.1
