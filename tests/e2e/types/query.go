...
type BSNFpsResponse struct {
	BSNFps []SingleBSNFpResponse `json:"fps"`
}

// SingleBSNFpResponse represents the finality provider data returned by the contract query.
...
type SingleBSNFpResponse struct {
